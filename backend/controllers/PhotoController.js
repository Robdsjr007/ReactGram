...
// Function check if photo belongs to user
const checkIfPhotoBelongsToUser = (photo, reqUser, res) => {
...
const deletePhoto = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ id: photo._id, message: "Foto excluída com suceso." });
    } catch (error) {
        // ID invalid
